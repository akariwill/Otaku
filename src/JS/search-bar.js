const totalNumberOfManga = document.querySelector(".total-manga span");

function updateNumberOfManga() {
  const container = document.querySelector("#mangaComponentMainContainer");
  const mangaCards = container.querySelectorAll(".manga-card");
  totalNumberOfManga.textContent = mangaCards.length;
}
